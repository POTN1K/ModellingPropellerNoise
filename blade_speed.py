...
def twist_poly(x):
    l= -8971.3298 + 206093.7010*x - 2.0708079035e6*(x**2) + 1.210070e7*(x**3) - 4.5793508e7*(x**4) + 1.18060411e8*(x**5) - 2.1196809e8*(x**6) + 2.65500274e8*(x**7) - 2.277350e8*(x**8) + 1.2759e8*(x**9) - 4.20825e7*(x**10) + 6.1972e6*(x**11)
...
df.to_csv(r"measurements/loads/blade.csv")
